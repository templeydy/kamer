...
description: Use persistent markdown planning files as working memory for complex multi-step tasks, including task plans, notes, deliverables, and checkpoint updates.
